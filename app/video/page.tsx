...
import { heroContent, objectiveContent, servicesContent, whyUsContent, FaqContent, partnersContent } from "@/db/video";
        ...
        <div className="flex web-page">
              ...
              <section className="services-comp flex" id="services">
                <div className="services-headline">
                    <h1>VIDEO SHOOT AND EDITING SERVICES</h1>
                    <h2>SmartGen offers cinematic video shoot and editing services that elevate brand storytelling, engage audiences, and drive results across digital platforms.</h2>
                </div>
