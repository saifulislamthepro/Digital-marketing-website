...
import { heroContent, objectiveContent, servicesContent, whyUsContent, FaqContent, partnersContent } from "@/db/design";
        ...
        <div className="flex web-page">
              ...
              <section className="services-comp flex" id="services">
                <div className="services-headline">
                    <h1>OUR GRAPHICS DESIGN SERVICES</h1>
                    <h2>SmartGen’s graphic design powers logos, social media, print materials, UI assets, brand kits, and ad creatives for impactful visual communication.</h2>
                </div>
              ...
              <section className="why-us flex">
                <div className="texts">
                  <h1>Why Choose SmartGen for Graphics and Branding Design?</h1>
                  <h2>SmartGen blends creativity, strategy, and emotional impact to craft visuals that build trust, drive engagement, and elevate brand identity.</h2>
                </div>
