...
import { heroContent, objectiveContent, servicesContent, whyUsContent, FaqContent, partnersContent, packSummaryContent } from "@/db/premium";
...
export default function Website() {
  ...
  return (
    <>    
      <head>
        <title>Smartgen Premium Package</title>
        <meta 
        name="description"
        content="Smartgen Offers Social media marketing based Premium Package to achive best result with comnplete solutions foronline businesses"/>
      </head>   
