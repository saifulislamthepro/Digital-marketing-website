...
import { heroContent, objectiveContent, servicesContent, whyUsContent, FaqContent, partnersContent, packSummaryContent } from "@/db/startup";
...
export default function Website() {
  ...
  return (
    <>     
      <head>
        <title>Smartgen startup Package</title>
        <meta 
        name="description"
        content="Smartgen Offers Social media marketing based startup Package to start online business "/>
      </head>  
        <div className="web-page">
              ...
              <section className="why-us flex">
                <div className="texts">
                  <h1>Why Choose SmartGens StartUp Package?</h1>
                  <h2>Here are four compelling reasons to choose the Startup Package from SmartGen Digital, crafted to resonate with ambitious founders and early-stage brand</h2>
                </div>
