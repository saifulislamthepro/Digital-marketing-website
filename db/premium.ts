...
export function heroContent () {
  ...
  {
    title: " SmartGen Premium Package",
    content: "Launch your brand with confidence, clarity, and conversion-focused digital assets — all in Premium package.",
...
const objectiveContent: content[] = [
  {
    ...
    content: "Startups, entrepreneurs, and businesses ready to make a bold digital debut. Whether you're launching a product, service, or personal brand — SmartGen equips you with everything needed to stand out, build trust, and grow fast.",
    subheading: "SmartGen Premium package is designed for startups, businesses with Best services of exactly what needs for an early stage",
...
const servicesContent: content[] = [
  ...
  },
  {
    ...
    content: "Your digital storefront — built to impress and convert:",
    imgUrl: "fi-rs-web-design",
    lists: [
        {list: "Custom homepage + 4 inner pages"},
        {list: "Responsive design for mobile/tablet"},
        {list: "Premium UI/UX with soft shadows, gradients, and modern layouts"},
        {list: "SEO-optimized structure and meta tags"},
        {list: "Google Search Console setup"},
        {list: "SSL security and speed optimization"}
    ]
  },
  {
